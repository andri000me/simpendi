            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo base_url('keuangan');?>" class="waves-effect"><i class="mdi mdi-view-dashboard"></i> <span> Dashboard </span> </a>
                        </li>
                        <li class="has_sub">
                            <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-spin fa-spinner"></i><span>Hibah Institusi </span> <span class="menu-arrow"></span></a>
                            <ul class="list-unstyled">
                                <li><a href="<?php echo base_url('keuangan/Penelitian/');?>">Penelitian</a></li>
                                <li><a href="<?php echo base_url('keuangan/Pengabdian/');?>">Pengabdian</a></li>
                                <li><a href="<?php echo base_url('keuangan/Riwayat/');?>">Riwayat</a></li>
                            </ul>
                        </li>
                        <li>
