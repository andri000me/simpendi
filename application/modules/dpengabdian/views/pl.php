                            ...
                            <div class="col-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="<?php echo base_url('dpengabdian/Review/download?file='.$hibah->laporan);?>" class="btn btn-info btn-rounded waves-effect waves-light">
                                            ...
                                            <div id="edit-modal-<?php echo $hibah->id; ?>-1" class="modal-demo">
                                                    ...
                                                    <div class="custom-modal-text">
                                                        <form method="post" action="<?php echo base_url('dpengabdian/Review/perbaikan_laporan');?>" data-parsley-validate novalidate enctype="multipart/form-data">
