                            ...
                            <div class="col-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            <td><a href="<?php echo base_url('administrasi/Penelitian/download?file='.$hibah->proposal);?>" class="btn btn-info btn-rounded waves-effect waves-light">
                                            ...
                                            <div id="edit-modal-<?php echo $hibah->id; ?>-1" class="modal-demo">
                                                    ...
                                                    <div class="custom-modal-text">
                                                        <form action="<?php echo base_url('administrasi/Penelitian/set_reviewer1');?>" data-parsley-validate novalidate method="post">
                                            ...
                                            <div id="edit-modal-<?php echo $hibah->id; ?>-2" class="modal-demo">
                                                    ...
                                                    <h4 class="custom-modal-title">Set Reviewer</h4>
                                                    <div class="custom-modal-text">
                                                        <form action="<?php echo base_url('administrasi/Penelitian/set_reviewer2');?>" data-parsley-validate novalidate method="post">
                                                        <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" 
                                                        value="<?=$this->security->get_csrf_hash();?>" style="display: none">
                                                        <input type="hidden" name="id" value="<?php echo $hibah->id; ?>">
