            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo base_url('administrasi');?>" class="waves-effect"><i class="mdi mdi-view-dashboard"></i> <span> Dashboard </span> </a>
                        </li>
                        <li class="has_sub">
                            <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-search"></i><span>Penelitian </span> <span class="menu-arrow"></span></a>
                            <ul class="list-unstyled">
                                <li><a href="<?php echo base_url('administrasi/Penelitian/');?>">Usulan Baru</a></li>
                                <li><a href="<?php echo base_url('administrasi/Penelitian/pu');?>">Perbaikan Usulan</a></li>
                                <li><a href="<?php echo base_url('administrasi/Penelitian/lp');?>">Laporan Pendahuluan</a></li>
                                <li><a href="<?php echo base_url('administrasi/Penelitian/pl');?>">Perbaikan Laporan</a></li>
                            </ul>
                        </li>
                        <li class="has_sub">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="<?php echo base_url('administrasi/Pengabdian/');?>">Usulan Baru</a></li>
                                <li><a href="<?php echo base_url('administrasi/Pengabdian/pu');?>">Perbaikan Usulan</a></li>
                                <li><a href="<?php echo base_url('administrasi/Pengabdian/lp');?>">Laporan Pendahuluan</a></li>
                                <li><a href="<?php echo base_url('administrasi/Pengabdian/pl');?>">Perbaikan Laporan</a></li>
                            </ul>
                        </li>
                        <li class="has_sub">
                            <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-file-text"></i><span>SK </span> <span class="menu-arrow"></span></a>
                            <ul class="list-unstyled">
                                <li><a href="<?php echo base_url('administrasi/SK/');?>">Upload SK</a></li>
                                <li><a href="<?php echo base_url('administrasi/SK/daftar_sk');?>">Daftar SK</a></li>
                            </ul>
                        </li>
                        <li>
