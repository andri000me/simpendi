                            ...
                            <div class="col-12">
                                <div class="card-box">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="p-20">
                                                <form class="form-horizontal row" role="form" action="<?php echo base_url('administrasi/Sk/upload_sk');?>" data-parsley-validate novalidate method="post" enctype="multipart/form-data">
