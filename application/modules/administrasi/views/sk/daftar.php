                            ...
                            <div class="col-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        foreach ($sk as $sk) { ?>
                                        <tr>
                                            <td><a href="<?php echo base_url('administrasi/Sk/download?file='.$sk->sk);?>" class="btn btn-danger btn-rounded waves-effect waves-light">
                                            ...
                                            <a href="<?php echo base_url('administrasi/Sk/delete?id='.$sk->id);?>" class="btn btn-danger btn-rounded waves-effect waves-light"
                                                ...
                                                <div id="edit-modal-<?php echo $sk->id; ?>-1" class="modal-demo">
                                                    ...
                                                    <div class="custom-modal-text">
                                                        <form action="<?php echo base_url('administrasi/Sk/edit_sk');?>" data-parsley-validate novalidate method="post" enctype="multipart/form-data">
