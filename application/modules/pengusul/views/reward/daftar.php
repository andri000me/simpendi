                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo base_url('pengusul/Reward/delete?id='.$data->id);?>" class="btn btn-danger btn-rounded waves-effect waves-light"
                                            ...
                                            <div id="edit-modal-<?php echo $data->id; ?>" class="modal-demo">
                                                    ...
                                                    <div class="custom-modal-text">
                                                        <form action="<?php echo base_url('pengusul/Reward/update');?>" data-parsley-validate novalidate method="post" enctype="multipart/form-data">
