                            ...
                            <div class="col-12">
                                <div class="card-box">
                                    ...
                                    <p class="text-muted m-b-30 font-14">
                                        Usulan pengajuan pengabdian kepada masyarakat pendanaan institusi
                                    </p>

                                    <div class="row">
                                        <div class="col-12">
                                            <div class="p-20">
                                                <form class="form-horizontal row" role="form" action="<?php echo base_url('pengusul/Pengabdian/store');?>" data-parsley-validate novalidate method="post" enctype="multipart/form-data">
